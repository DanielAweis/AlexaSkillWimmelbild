...
class RainbowIntentHandler(AbstractRequestHandler):
    """Handler for Rainbow Intent."""
    
    # object name
    object_name = "rainbow"
    global object_german
    object_german = "den Regenbogen"
    ...
    def can_handle(self, handler_input):
        ...
        return ask_utils.is_intent_name("RainbowIntent")(handler_input)
