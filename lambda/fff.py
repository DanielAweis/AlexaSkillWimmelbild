...
class FridaysIntentHandler(AbstractRequestHandler):
    """Handler for Fridays Intent."""
    
    # DW: object name
    object_name = "fridays"
    global object_german
    object_german = "den Fridays for Future-Planeten"
    ...
    def can_handle(self, handler_input):
        ...
        return ask_utils.is_intent_name("FridaysIntent")(handler_input)
