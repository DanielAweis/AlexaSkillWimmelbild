...
class ChemieIntentHandler(AbstractRequestHandler):
    """Handler for Help Intent."""
    
    # object name
    object_name = "chemistry"
    global object_german
    object_german = "die Chemie"
    ...
    def can_handle(self, handler_input):
        ...
        return ask_utils.is_intent_name("ChemieIntent")(handler_input)
