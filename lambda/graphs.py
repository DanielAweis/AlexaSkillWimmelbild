...
class GraphsIntentHandler(AbstractRequestHandler):
    """Handler for Graphs Intent."""
    
    # DW: object name
    object_name = "graphs"
    global object_german
    object_german = "die Graphen"
    ...
    def can_handle(self, handler_input):
        ...
        return ask_utils.is_intent_name("GraphsIntent")(handler_input)
