...
class MatheIntentHandler(AbstractRequestHandler):
    """Handler for MatheIntent."""
    
    # DW: object name
    object_name = "math"
    global object_german
    object_german = "die Mathetafel"
    ...
    def can_handle(self, handler_input):
        ...
        return ask_utils.is_intent_name("MatheIntent")(handler_input)
